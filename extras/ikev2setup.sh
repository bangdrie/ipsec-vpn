#!/bin/bash
#
# Script untuk set up IKEv2 pada Ubuntu, Debian dan CentOS/RHEL
#
...
Error: Your must first set up the IPsec VPN server before setting up IKEv2.
  See: https://github.com/umarhadi/ipsec-vpn
EOF
  exit 1
fi
...
Error: Libreswan version '$swan_ver' is not supported.
  ...
  https://github.com/umarhadi/ipsec-vpn#upgrade-libreswan
EOF
    exit 1
    ;;
esac
...
Alternatively, you may manually set up IKEv2. See: https://bit.ly/ikev2-howto
